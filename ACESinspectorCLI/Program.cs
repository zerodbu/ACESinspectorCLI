        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                using (StreamWriter sw = new StreamWriter(assessmentFilename))
                {
                    ...
                    sw.Write("<Row><Cell><Data ss:Type=\"String\">Validation tool</Data></Cell><Cell ss:StyleID=\"s64\" ss:HRef=\"https://github.com/zerodbu/ACESinspectorCLI\"><Data ss:Type=\"String\">ACESinspectorCLI version 1.0.0.16</Data></Cell><Cell ss:StyleID=\"s62\"><Data ss:Type=\"String\"></Data></Cell></Row>");
